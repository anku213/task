...
let getPrescription = async (req, res) => {
    try {
        const data = "SELECT * FROM tbl_prescription"
...
let postPrescription = async (req, res) => {
    try {
        const data = req.body;
        const querry = 'INSERT INTO tbl_prescription  SET ?';
...
let putPrescription = async (req, res) => {
    try {
        ...
        q3 = "UPDATE tbl_prescription SET ? WHERE prescription_no = ?";
...
let deletePrescription = async (req, res) => {
    try {
        ...
        q4 = "DELETE FROM tbl_prescription WHERE prescription_no = ?"
